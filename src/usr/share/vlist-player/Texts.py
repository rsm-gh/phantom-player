...
TEXT_RENAME="Rename"
TEXT_RESET="Reset"
TEXT_ADD_PICTURE="Add Picture"
TEXT_DELETE="Delete"
TEXT_PLAY="Play"
TEXT_O_PLAYED="O-Played"
TEXT_R_PLAYED="R-Played"
TEXT_CHOOSE_FILE="Select a file"
TEXT_SERIE_ALREADY_EXISTS="The folder that you choose is already in a series."

TEXT_DELETE_SERIE='''Are you sure that you want to delete "{0}"?
 
(the files will not be deleted from the hard drive)'''

TEXT_RESET_SERIE='''Are you sure that you want to reset
...
TEXT_SERIE_NAME_ALREADY_EXISTS='''The series "{}" already exists, it is not possible
to have two series with the same name. 

Please rename the other series before adding this one.'''

TEXT_SERIE_NEWNAME_ALREADY_EXISTS='''The series "{}" already exists, it is not possible
to have two series with the same name. 

Please choose a different name.'''

TEXT_END_OF_SERIE='''All the videos of the series have been played'''
...
TEXT_CANT_PLAY_SERIE_MISSING='''The media can not be reproduced because the series
is missing!
