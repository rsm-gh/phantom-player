...
#
# Copyright (c) 2024-2016, 2024-2025 Rafael Senties Martinelli.
#
...
class PhantomPlayer:
    ...
    def __init__(self, application):
        ...
        builder = Gtk.Builder()
        builder.add_from_file(system_utils.join_path(os.path.dirname(os.path.realpath(__file__)), "PhantomPlayer.glade"))
